...
public class HListener {
    public static void main(String[] args) throws UnknownHostException {
		...
		IMap<Long, Dziekanat> students = instance.getMap("dziekanat");

		students.addEntryListener(new EntryAddedListener<Long, Dziekanat>() {

			@Override
			public void entryAdded(EntryEvent<Long, Dziekanat> e) {
				System.out.println(e);
			}
		}, true);
